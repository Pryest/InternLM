...
MODEL_ONLY_FOLDER = "local:/mnt/petrelfs/share_data/llm_llama/llama2_raw/llama-2-70b/"
# Ckpt folder format:
...
ckpt = dict(
    ...
    load_ckpt_info=dict(path=MODEL_ONLY_FOLDER, content=("model",), ckpt_type="LLAMA"),
